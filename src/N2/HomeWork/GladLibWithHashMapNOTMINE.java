...
public class GladLibWithHashMapNOTMINE {
    ...
    public GladLibWithHashMapNOTMINE(){
    ...
    public GladLibWithHashMapNOTMINE(String source){
    ...
    public static void main(String[] args) {
        GladLibWithHashMapNOTMINE g = new GladLibWithHashMapNOTMINE();
        g.makeStory();
    }
